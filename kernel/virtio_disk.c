...
virtio_disk_init(void)
{
  ...
  *R(VIRTIO_MMIO_QUEUE_DESC_HIGH) = (uint32)disk.desc >> 16;
  *R(VIRTIO_MMIO_DRIVER_DESC_LOW) = (uint32)disk.avail;
  *R(VIRTIO_MMIO_DRIVER_DESC_HIGH) = (uint32)disk.avail >> 16;
  *R(VIRTIO_MMIO_DEVICE_DESC_LOW) = (uint32)disk.used;
  *R(VIRTIO_MMIO_DEVICE_DESC_HIGH) = (uint32)disk.used >> 16;
